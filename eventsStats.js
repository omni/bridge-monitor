...
async function main(){
  try {
    ...
    return {   
      foreignDeposits: foreignDeposits.length,
      homeDeposits: homeDeposits.length,
      homeWithdrawals: homeWithdrawals.length,
      foreignWithdrawals: foreignWithdrawals.length,
